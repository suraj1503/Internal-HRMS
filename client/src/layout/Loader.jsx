...
const Loader = () => {
  return (
    <>
      ...
      <div id="toast-danger" className="flex items-center justify-center w-full max-w-xs p-3 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
